        ...
        bottom: PreferredSize(
          ...
          child: Column(
            ...
            children: [
              ...
              //Checkout Container
              CartProv.cartItems.length >0? Container(
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                onTap: ()
                {
                  navigateToDiscountPage(context);
                },
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Icon(Icons.local_shipping_outlined,color: black.withOpacity(0.8),size: MediaQuery.sizeOf(context).height*0.025,),
                ...
                Icon(Icons.keyboard_arrow_right,color: black.withOpacity(0.8),size: MediaQuery.sizeOf(context).height*0.025,)
