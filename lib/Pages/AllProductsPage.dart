...
import 'package:lakesamerica/CustomWidgets/AllCatSlider.dart';
import 'package:lakesamerica/CustomWidgets/ShopPageProductsGridview.dart';

import '../Constants/colors.dart';
import '../CustomWidgets/PopularCategories.dart';
      ...
      body: CustomScrollView(
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            automaticallyImplyLeading: false,
            leadingWidth: 0,
            title: //Popular Categories Slider
            AllCatSlider(),
            ...
            bottom: PreferredSize(
              ...
              child: Container(
                ...
                child: ListView(
                  ...
                  padding:  EdgeInsets.only(left: MediaQuery.of(context).size.height*0.015,bottom: 10,top: 10),
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  const Icon(Icons.keyboard_arrow_left,size: 18,)
                                ],
                              ),
                            ),
                        );
